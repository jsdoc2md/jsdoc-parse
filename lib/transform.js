...
function sortIdentifier(identifier){
    var fieldOrder = [ "id", "longname", "name", "scope", "kind", "isExported", "classdesc", "augments", "inherits", "inherited", "overrides", "mixes", "description", "memberof", "alias", "params", "fires", "examples", "returns", "type", "defaultvalue", "readonly", "isEnum", "properties", "optional", "nullable", "variable", "author", "deprecated", "ignore", "access", "requires", "version", "since", "licenses", "license", "typicalname", "category", "see", "exceptions", "codeName", "todoList", "customTags" ];
