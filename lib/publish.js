/* 
store IDs which have been updated in a module level var.. any subsequent members found with this ID are updated.. depends on sort order, i.e. exported class first. "use strict";
*/
...
exports.publish = function(data) {
    ...
    json = json.map(function(identifier){
        identifier = transform.setIsExportedFlag(identifier);
        identifier = transform.setCodename(identifier);
        ...
        // identifier = transform.sortIdentifier(identifier);
        // identifier = transform.wantedProperties(identifier);
        return identifier;
    });
