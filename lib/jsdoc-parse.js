...
jsdocParse.cliOptions = [
    ...
    { name: "src", alias: "f", type: String, multiple: true, defaultOption: true, description: "A list of javascript source files (or glob expressions) to parse for documentation", typeLabel: "<files>" },
