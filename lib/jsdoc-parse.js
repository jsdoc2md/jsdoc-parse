...
jsdocParse.cliOptions = [
    { name: "src", alias: "f", type: String, multiple: true, defaultOption: true, description: "A list of javascript source files (or glob expressions) to parse for documentation. If this option is not set jsdoc-parse will wait for source code on stdin (i.e. `cat *.js | jsdoc-parse <options>`).", typeLabel: "<files>" },
    { name: "private", alias: "P", type: Boolean, description: "Include identifiers marked @private in the output" },
    { name: "html", alias: "H", type: Boolean, description: "Enable experimental parsing of .html files" },
    { name: "sort-by", type: String, multiple: true, alias: "s",
      description: "Sort by one of more fields, e.g. `--sort-by kind category`. Defaults to `[ \"scope\", \"category\", \"kind\", \"order\" ]`. Pass the special value `none` to remove the default sort order. ", typeLabel: "<fields>"
    },
