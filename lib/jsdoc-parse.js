...
jsdocParse.cliOptions = [
    ...
    { name: "sort-by", type: Array, alias: "s",
      description: "Sort by one of more fields, e.g. `--sort-by kind category`. Defaults to `[ \"scope\", \"category\", \"kind\", \"order\" ]`. Pass the special value `none` to remove the default sort order. "
    }
];
