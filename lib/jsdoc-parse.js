...
function sort(array, sortBy){
    if (!sortBy || sortBy === "none"){
        ...
        return a.sortBy(array, "kind", "order", order);
    } else if (sortBy === "scope"){
        return a.sortBy(array, "scope", "order", order);
    } else if (sortBy === "kind,scope"){
        return a.sortBy(array, "kind", "scope", "order", order);
    } else if (sortBy === "scope,kind"){
        return a.sortBy(array, "scope", "kind", "order", order);
    } else if (sortBy === "ting"){
        return a.sortBy(array, "memberof", "scope", "kind", "order", order);
    } else {
